...
if( $app->cfgCon("aa478")){ 
	...
	$app->addWithDupCheck(array('FirstName' => $newcontactname, 'Email' => $newcontactemail,'JobTitle' => $newcontactjob, 'Company' => $company),'Email');
	...
	$grp = array('_EventAbbrevation'  => $eventabbrevation,
